...
Here, UI elements Filament provides can be used to build interactive data tables, forms, and views. The package provides filtering and sorting options by default, easily configurable searching, and relationships can be displayed through more descriptive fields as well. For example, instead of displaying the user's ID, their name can be retrieved for a better UX.
Further customization is possible, but the defaults cover most use cases.

In Figure \ref{fig:admin-panel}, a data table view of the sites can be seen.
...
It also checks for allowed states.
...
An overview of the previous two functionalities of a site's detail view can be seen in Figure \ref{fig:admin-detail}.

...
The Spatie Laravel Permission package adds the role related tables, which I will talk about in more detail in the authorization Section \ref{section:authorization}.

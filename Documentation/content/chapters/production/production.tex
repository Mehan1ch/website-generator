...
Such concrete options are Azure AKS or AWS EKS, as they have vast amounts of computing resources available.
...
I believe the above considerations should help one get started in deploying the developed SaaS into production and help consider various scenarios and use cases.

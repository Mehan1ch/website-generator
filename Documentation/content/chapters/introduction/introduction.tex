...
However, most of them have a steep learning curve, and provide either no free tier or a very limited one.
As a site gets complex, a subscription in these services will be unavoidable.

This thesis presents a free, lightweight SaaS platform designed for simple use cases, websites made of static pages that display essential information with minimal setup.

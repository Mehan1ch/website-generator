...
In a cloud environment consumers rely on a scale-out solution more by default due to the available amount of resources and also due to the fact that increasing a machines resources is only feasible up to a level.

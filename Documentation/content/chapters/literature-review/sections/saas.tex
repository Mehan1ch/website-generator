...
However, most complex production system usually combine the two forms in some form.
...
Scaling solutions are also made tenant aware so that each tenant gets scaled for their respective needs \cite{scalable}.

...
Next it sends the incoming request to the HTTP kernel which bootstraps all necessary service providers, and executes application level middleware.
...
Most notably Spatie \cite{spatie} whose team maintain many packages and tools for the framework and FilamentPHP, which is a plugin extendable admin panel and UI (user interface) framework \cite{filament}.

% TODO: kicsit több az artisan cli-t mindenképp
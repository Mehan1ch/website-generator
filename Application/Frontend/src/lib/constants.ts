import {EditorCard, EditorCardBottom, EditorCardTop} from "@/routes/_app/-components/editor/components/editor-card.tsx";
...
export const EDITOR_RESOLVER = {EditorCard, EditorButton, EditorText, EditorContainer, EditorCardTop, EditorCardBottom};
